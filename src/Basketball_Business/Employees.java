...
public class Employees {
    ...
    Employees(){															//Part 1.4 Constructor with no argument
    ...
    Employees(int ordinaryno){														//Part 1.4 Constructor with 1 argument
    ...
    Employees(int executiveno, String[] executivename){						//Part 1.4 Constructor with 2 argument
        System.out.print("Please enter the number of ordinary employee: ");
        ordinaryno = scan.nextInt();
