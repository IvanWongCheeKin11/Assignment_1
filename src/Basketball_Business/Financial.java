...
public class Financial {
    ...
    Financial(){																						//Part 1.4 Constructor with no argument
    ...
    Financial(double sales){																			//Part 1.4 Constructor with 1 argument
    ...
    Financial(double sales, double costofgoods){														//Part 1.4 Constructor with 2 argument
        System.out.printf("This month's sales: RM%.2f%n",sales);
